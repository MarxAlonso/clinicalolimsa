...
class ExampleMockitoTest {
    ...
    void testFindAllMedicines() {
        ...
        // Arrange
        Medicamentos med1 = createMedicine(1, "Aspirina", 10.0);
        Medicamentos med2 = createMedicine(2, "Ibuprofeno", 15.0);
        Medicamentos med3 = createMedicine(3, "Paracetamol", 8.0);
    ...
    void testSaveMedicine() {
        ...
        assertEquals("NuevoMedicamento", result.getNombre());
